        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-elevated">
              <img src={entrepreneurWoman} alt="Entrepreneur supported by Demo Credit Limited" className="w-full h-[400px] md:h-[520px] object-cover" />
            </div>
          ...
          {/* Content */}
          <div>
            <span className="text-primary font-semibold text-sm tracking-wide uppercase">About Demo Credit Limited</span>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-4 font-body">
              Demo Credit Limited is a financial services company dedicated to providing loans to entrepreneurs, traders, and everyday business owners. Founded with a deep commitment to financial inclusion, we exist to bridge the gap between ambition and opportunity.
            </p>
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-8 font-body">
              At Demo Credit Limited, we believe that when businesses grow, communities thrive. That's why we go beyond lending — offering financial literacy training, business advisory support, and a genuine partnership that helps our clients build sustainable, profitable enterprises.
            </p>
