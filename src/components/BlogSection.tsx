...
const articles = [
  {
    ...
    excerpt: "With a small loan from Kechita Capital, Mercy Banda bought her first industrial sewing machine. Two years later, she employs two apprentices and serves customers from three districts. Her story is a testament to what happens when talent meets opportunity.",
  ...
  },
  {
    ...
    excerpt: "Group lending isn't just about shared accountability — it's about building a community of support. Meet the women's business group in Lilongwe that has collectively borrowed from Kechita and built a thriving network of mutual encouragement.",
