      ...
      <header className="bg-background shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img src={logo} alt="Kechita Capital" className="h-10 w-auto rounded" />
            <span className="font-display font-bold text-xl text-foreground hidden sm:block">Kechita Capital</span>
          </Link>
